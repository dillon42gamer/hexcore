...
<head>
    ...
    <meta property="og:title" content="Play Plant vs Zombies Online" />
    <meta property="og:description" content="Play Plant vs Zombie here for Free - A tower defense game created by PopCap Games and released on May 5, 2009. Click to Play now!" />
    ...
    <meta name="twitter:title" content="Play Plant vs. Zombies Online" />
    <meta name="twitter:description" content="Play Plant vs. Zombie here for Free - A tower defense game created by PopCap Games and released on May 5, 2009. Click to Play now!" />
...
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"8dff28b7dda07e25","version":"2024.10.4","r":1,"token":"23f6e3f971324cbcaac6e0b307fc037d","serverTiming":{"name":{"cfExtPri":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}}}' crossorigin="anonymous"></script>
</head>
<body>
   ...
   <div id="preloader">
	...
	<div id="dPause">
		...
		<div class="button" onclick="ResetGame($('dMenu0'))">Continue</div>
	</div>
	<div id="dSurfaceBack">
		...
		<div id="dOptionsMenuback">
			<div id="dOptionsMenu">
				<div class="OMd0">
					<div class="OMd1">
						<div><input type="checkbox" id="cAutoSun" value="1" onchange="CheckAutoSun(this)"> <label for="cAutoSun" id="lAutoSun">Auto pick up sunlight</label></div>
						<div><input type="checkbox" id="cSilence" value="1"> <label for="cSilence" id="lSilence">Mute sound</label></div>
					</div>
				</div>
...
LvlList=function(BLvl,SLvl1,SLvl2){
	...
	do{
		s+='<span class="lvl" onclick="StartAdventure('+(startlvl+SLvl1)+')">No. 1'+ArLvl[SLvl1]+'close</span>';
	}while(SLvl1++<SLvl2)
	document.write(s);
};
</script>
		...
		<div id="dAdvSmallContainer" class="TitleSmallContainer Challenge_Background">
			<div id="dAdvSmallTitle">Adventure Mode</div>
			<div class="list">
				<div class="title">Grass during the day</div>
				<div class="icon">
			...
			<div class="list">
				<div class="title">Grass at night</div>
				<div class="icon">
			...
			<div class="list">
				<div class="title">East China Sea Dragon Palace</div>
				<div class="icon">
			...
			<div class="list">
				<div class="title">Water Town Jiaxing</div>
				<div class="icon">
			...
			<div class="button" onmouseover="this.style.backgroundPosition='bottom'" onmouseout="this.style.backgroundPosition='top'"  onclick="HiddenLevel()">Close</div>
		</div>
		
		<div id="dMiniSmallContainer" class="TitleSmallContainer Challenge_Background">
			<div id="dMiniSmallTitle">China Pavilion - Dave's China Trip</div>
			<div id="dMini0">
				<table cellspacing="10" width="100%">
				<script>
					(function(){
						var ar=['100','New to China','wall0.png',
						'101','Assassination','wall1.png',
						'102','Night falls','wall2.png',
						'103','Stand out','wall3.png',
						'104','Ancient water village','zhi.png',
						'105','Water sports','zhi1.png',
						'106','Grave village','bai.png',
						'107','Ghost night','bai1.png',
						'108','Foot of volcano','huo.png',
						'109','Add fuel to the fire','huo1.png',
						'110','Devils Palace','wang.png',
						'111','Corpse siege','wang0.png',
						'112','Decisive battle against the Qin emperor','wang1.png',
						'FB','Battle of the Pass','FB.png',
						'WJY','Meeting with Jiang Yi','WJY.png'],
				...
				<div class="button" onmouseover="this.style.backgroundPosition='bottom'" onmouseout="this.style.backgroundPosition='top'"  onclick="HiddenMiniGame()">Close</div>
			</div>
		</div>
</div>
		<div id="dRiddleSmallContainer" class="TitleSmallContainer Challenge_Background">
			...
			<div id="dMini0">
				...
				<script>
					(function(){
						var ar=['NutBowling','Nut Bowling ','baolingqiu.png',
						'GuanXin','Stargazing','GuanXin.png',
						'yy','tit for tat','yy.png',
						'ZombieGames','Zombie Games','woxinfeixiang.png',
						'yicixingxiaofei','one-time consumption','yicixingxiaofei.gif',
						'kaotianchifan','eat by the sky','kaotianchifan.png',
						'pinjizhidi','three-way defense','pinjizhidi.png',
					                'bpsyc','doll box market','bpsyc.png',
						'fmdzz','Three Columns of Defense','fmdzz.png',
						'ydbs','a lot','ten.png',
						'KongXi','air raid','KongXi.png',
						'YXZZ','Stealth Campaign','YXZZ.png',
						'xjsdmf','Little Zombies in Big Trouble','sm.png',
						'QRWX','24/7','QRWX.png',
                                                                                                '150','Evergreen Tower','mota.png'],
						v,i=0,n,l=ar.length,s='';
						for(n=0;n<l;n+=3){
							i%5==0&&(s+='<tr>');
							s+='<td height="139" valign="top" onclick="SelectModal(\''+ar[n]+'\')"><div><img src="images/interface/'+ar[n+2]+'"></div><div class="list">'+ar[n+1]+'</div></td>';
			...
			<!--单机界面已作废，无特殊请勿乱动-->
			<div id="dRiddle0">
				<div class="button" onmouseover="this.style.backgroundPosition='bottom'" onmouseout="this.style.backgroundPosition='top'"  onclick="ReturnRiddleInx()">Puzzle Mode Index</div>
			</div>
			<!--对战界面已作废，无特殊请勿乱动-->
			<div id="dRiddle1">
				<div style="position:relative;width:94%;font-size:12px;margin-top:10px;margin-left:auto;margin-right:auto;color:#000">
					...
					<button class="jhp" style="height:23px" onclick="window.frames['fRiddleAlreadyCreateGame'].SearchLvl(1)">I created</button> 
					<button class="jhp" style="height:23px" onclick="window.frames['fRiddleAlreadyCreateGame'].SearchLvl(2)">i played</button>&nbsp;&nbsp;&nbsp;
					<input type=text id="tRiddleID" size="1"><button class="jhp" style="height:23px" onclick="window.frames['fRiddleAlreadyCreateGame'].SearchLvl(3,$('tRiddleID').value)">Serial number query</button>&nbsp;&nbsp;&nbsp;
					<input type=text id="tRiddleUserName" size="3"><button class="jhp" style="height:23px" onclick="window.frames['fRiddleAlreadyCreateGame'].SearchLvl(4,$('tRiddleUserName').value)">Created by query</button>&nbsp;&nbsp;&nbsp;
					<input type=text id="tRiddleTitle" size="3"><button class="jhp" style="height:23px" onclick="window.frames['fRiddleAlreadyCreateGame'].SearchLvl(5,$('tRiddleTitle').value)">Title query</button>
				...
				<div class="button" onmouseover="this.style.backgroundPosition='bottom'" onmouseout="this.style.backgroundPosition='top'"  onclick="ReturnRiddleInx()">Title Rebel Mode Index</div>
				<div class="button" style="left:220px" onmouseover="this.style.backgroundPosition='bottom'" onmouseout="this.style.backgroundPosition='top'"  onclick="if($User.Visitor.UserName!='游客'||confirm('Visitors can only experience the creation function and cannot be archived\nPlease use registered users to save your creativity!'))SelectModal('ImZombieCreateGame')">Create a new level</div>
			</div>
	...
	<div id="dZombie"></div>
	<div id="bShowHandBook" onmouseover="this.style.backgroundPosition='bottom'" onmouseout="this.style.backgroundPosition='top'" onclick="ViewHandBook()">Handbook&nbsp;</div>
	<div id="dSelectCard">
		<div class="title"></div>
		<div id="dPCard"></div>
		<div class="bTitle">
	...
	<div class="title">Handbook - Index</div>
	<div class="content">
		<div>
			<img border="0" src="images/Plants/SunFlower/0.gif" width="73" height="74"><br>
			<input class="button" type="button" value="View Plants" name="btnViewPlant" id="btnViewPlant" onclick="InitHandBookPCard()">
		</div>
		<div style="left:50%;padding-top:95px">
			<img border="0" src="images/Zombies/Zombie/0.gif" width="149" height="130"><br>
			<input class="button" type="button" value="View Zombies" name="btnViewZombie" id="btnViewZombie" onclick="InitHandBookZCard()">
		</div>
	</div>
	...
	<div id="dHandBookP">
		<div class="title">Handbook - Plants</div>
		...
		<div class="list">
			...
			<div class="cost_cool">
				<span class="cost">Cost: </span><span id="spSunNum"></span><span class="cool">Cool down: </span><span id="spCoolTime"></span>
			</div>
		</div>
	</div>
	<div id="dHandBookZ">
		<div class="title">Handbook - Zombies</div>
	...
	<div class="dButton">
		<div class="button1" onmouseover="this.style.backgroundPosition='bottom'" onmouseout="this.style.backgroundPosition='top'" onclick="ReturnHandBookInx()">Handbook Index</div>
    ...
    <div id="dNewPlant">
	<div id="dNewPlantTitle">You got a new plant!</div>
	<div class="card">
    ...
    <div id="dProcess">
	<input class="button" type="button" value="closure" onclick="SetHidden($('dProcess'))">
	...
	<div class="title">At the request of players, the game speed adjustment function is especially introduced</div>
	<div class="dSpeed" title="Click on a speed to select soft acceleration">
		<div class="dS1">Click on the corresponding speed</div>
		<div class="dS2"><div onclick="CSpeed(1,20,.5)">1/2<br><br>┕━</div><div onclick="CSpeed(1,10,1)">original speed<br><br>━┻━</div><div onclick="CSpeed(2,10,2)">2<br><br>━┻━</div><div onclick="CSpeed(5,10,5)">5<br><br>━┻━</div><div onclick="CSpeed(5,5,10)">10<br><br>━┛</div></div>
	</div>
	<div class="nowspeed">Current game speed:<span id="dDisplaySpeed">1</span> Double speed</div>
	<div class="content"><span>&nbsp;&nbsp;&nbsp; Speed Continue</span>: Ideally, the speed adjustment provided by the game is<font color="#FFFF00">1/2 speed - 10 times speed</font>. But the speed Continue effect is related to your browser and computer. For example, IE6 browser can't be expected to be 10 times faster on a good computer.<br>&nbsp;&nbsp;&nbsp; After the speed adjustment, the visual visual of the screen may occasionally feel a bit sluggish, and at relatively high speeds, some browsers may not be able to achieve the acceleration effect or can only accelerate for a short time and then slow down.<br>&nbsp;&nbsp;&nbsp; <span style="color:#FF0"><b>Finally, it is strongly recommended to use IE9, Chrome, FireFox, Opera browsers, so that you can experience the feeling of a machine gun with a pea shooter！<br>&nbsp;&nbsp;&nbsp; Disclaimer: Limited by browsers and computers, this speed adjustment does not guarantee that the effect of the selected speed will be achieved!</b></span></div>
	<br>
	<div><input type=button value="back to game" onclick="HiddenSpeed()">&nbsp;&nbsp; <input type=button value="restore speed" onclick="CSpeed(1,10,1)"></div>
    </div>
    <script>
