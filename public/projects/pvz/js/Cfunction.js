var $User = function() {
    ...
    oS = {
        ...
        CheckImg: function(b, a) {
            ...
            $("sFlagMeterTitleF").innerHTML = '<span style="cursor:pointer;font-family:Tahoma;color:#fff">Loading...(' + c.AccessNum + "/" + c.PicNum + ")</span>";
        ...
        LoadReady: function(f) {
            ...
            var d = function(h) {
                ...
                i.ShowScroll ? oSym.addTask(h == undefined ? 200 : h, function(j) {
                    ClearChild(j);
                    i.ScrollScreen()
                }, [NewEle("DivParty", "div", "line-height:50px;color:#FFFFFF;font-size:50px;font-family:Tahoma", {}, EDAll)]) : (SetVisible($("dMenu")), AutoSelectCard(), LetsGO())
            };
        ...
        Init: function(a) {
            ...
            a && a.FlagNum ? (r.FlagHeadStep = Math.floor(140 / (a.FlagNum - 1)), r.MonPrgs = function() {
                var u = oP,
                    j, i = u.FlagZombies,
                    s, t, f = $User.Visitor;
                !--u.NumZombies && (i < u.FlagNum ? (u.ReadyFlag = ++i, oSym.addTask(500, u.FlagPrgs, [])) : (u.FlagToEnd(), $User.isAuthorWebsite && $User.Visitor.UserName != "" && (ClearChild($("JSPVZAjax")), f.SaveLvl && NewEle("JSPVZAjax", "script", 0, {}, document.body)), f.SaveLvlCallBack && f.SaveLvlCallBack({
                    UserName: f.UserName,
                    SunNum: oS.SunNum,
                    Lvl: s,
    ...
    GroundOnmousemove1 = function(j) {
        ...
        SetStyle($("MovePlant"), {
            left: d - .5 * (l.beAttackedPointL + l.beAttackedPointR) + "px",
    ...
    GroundOnmousemove2 = function(k) {
        ...
        var j = n[1],
            l = j ? j.id : "",
            p = oS.MPID;
        p != l && (p && SetAlpha($(p).childNodes[1], 100, 1), (oS.MPID = l) && SetAlpha($(l).childNodes[1], 60, .6));
        SetStyle($("tShovel"), {
            left: d - 15 + "px",
            top: b - 16 + "px"
        })
    ...
    DisplayZombie = function() {
        ...
        while (b) {
            ...
            g.CanDisplay ? (d.splice(a, 1), e[b--] = g.getHTML("", Math.floor(50 + Math.random() * 201) - g.width * .5, f[b] - g.height, 1, "block", "auto", g.GetDTop, g.PicArr[g.StandGif])) : --b
        }
    ...
    ViewCardTitle = function(b, c) {
        ...
        var f = $("dTitle"),
            a = b.prototype;
        f.innerHTML = a.CName + "<br>cooldown:" + a.coolTime + "Second<br>" + (oS.DKind && a.night ? '<span style="color:#F00">Nocturnal - sleeps during the day</span><br>' + a.Tooltip : a.Tooltip || '<span style="text-align:left">' + a.Produce + "</span>");
        SetStyle(f, {
    ...
    ViewPlantTitle = function(b) {
        var f = $("dTitle"),
            ...
            c = e.PName.prototype,
            a = c.CName;
        !oS.CardKind && (a += "<br>cooldown:" + c.coolTime + "Second<br>" + c.Tooltip, !e.CDReady && (a += '<br><span style="color:#F00">ReLoading...</span>'));
        !e.SunReady && (a += '<br><span style="color:#F00">Not enough sunlight!</span>');
        f.innerHTML = a;
        SetStyle(f, {
            top: 60 * b + "px",
    ...
    DoCoolTimer = function(c, b) {
        ...
        (function(d, e) {
            d > 0 ? (innerText($("dCD1" + e), d), innerText($("dCD2" + e), d), oSym.addTask(50, arguments.callee, [(d - .5).toFixed(1), e])) : (ClearChild($("dCD1" + e), $("dCD2" + e)), ArCard[e].CDReady = 1, MonitorCard())
        })(b, c)
    },
    ChosePlant = function(h, d) {
        ...
        var b = h.clientX - EDAlloffsetLeft + EBody.scrollLeft || EElement.scrollLeft,
            ...
            f, c = j.PicArr;
        oS.Chose = 1;
        !oS.CardKind ? EditImg(NewImg("MovePlant", c[j.StaticGif], "left:" + b - .5 * (j.beAttackedPointL + j.beAttackedPointR) + "px;top:" + a + 20 - j.height + "px;z-index:254", EDAll).cloneNode(false), "MovePlantAlpha", "", {
            visibility: "hidden",
            filter: "alpha(opacity=40)",
            opacity: .4,
            zIndex: 30
        }, EDAll) : (NewImg("MovePlant", j.PicArr[j.StandGif], "left:" + (b - .5 * (j.beAttackedPointL + j.beAttackedPointR)) + "px;top:" + (a + 20 - j.height) + "px;z-index:254", EDAll), NewImg("MovePlantAlpha", j.PicArr[j.StandGif], "visibility:hidden;filter:alpha(opacity=40);opacity:0.4;z-index:30", EDAll));
        while (e--) {
    ...
    AppearSun = function(h, f, e, a) {
        ...
        }, [g, h, d, Math.floor(Math.random() * 4), [-32, -24, -16, -8],
            [-1, 1][Math.floor(Math.random() * 2)], 8, 2
    ...
    MoveClickSun = function(b) {
        ...
        (function(k, l, n, s, m, r, j, q, p) {
            (m -= q) > n ? (SetStyle($(k), {
                left: m + "px",
                top: (r -= p) + "px"
            }), oSym.addTask(j, arguments.callee, [k, l, n, s, m, r, j += .3, q, p])) : (SetStyle($(k), {
                left: n + "px",
                top: s + "px"
    ...
    PrepareGrowPlants = function(a) {
        var b = function() {
            ...
            }, [NewEle(0, "div", "position:absolute;overflow:hidden;background:url(images/interface/PrepareGrowPlants.png) no-repeat;width:255px;height:108px;z-index:50;left:" + (oS.W * .5 - 77) + "px;top:" + (oS.H * .5 - 54) + "px", 0, EDAll), a])
        };
    ...
    GetNewCard = function(a, b, c) {
        ...
        oSym.Init(function(d, e) {
            ++d < 100 ? (SetAlpha(e, d, d * .01), oSym.addTask(4, arguments.callee, [d, e])) : function() {
                StopAudio("winmusic");
    ...
    InitGame = function() {
        var e = NewEle("dServer", "div", "position:absolute;line-height:28px;left:706px;top:245px;width:700px;height:100px;font-size:16px;color:#040;font-family:Tahoma;font-weight:bold;z-index:2;display:none", 0, $("dAll")),
            c = $User.Server,
            b = c.List,
            a = $("dProcess");
        !$("dText1") && a.insertBefore(NewEle("dText1", "div", 0, {
            innerHTML: '<span style="line-height:23px;font-size:15px;font-family:&#x9ED1;&#x4F53;;color:#F60;top:32px">Welcome to experience<span style="font-family:Tahoma;font-weight:700">The new version of Plants vs. Zombies JS</span>,The program is made by the player, not affiliated with any for-profit company.<span style="font-family:Tahoma;font-weight:700">LonelyStar and Jiangnan Game Development Company</span>All rights reserved to the program,The game theme, material and sound effects are owned by Popcap Games, Electronic Arts, and individual background music sources are free music websites. If you need to reprint, please keep the above copyright instructions, otherwise it will be treated as piracy.</span>'
        }, 0), a.firstChild);
        LoadLvl()
    },
    ...
    ClickMenu = function() {
        oSym.Timer && (AllAudioPaused(), PlayAudio("pause"), oSym.Stop(), SetBlock($("dSurface")), innerText($("dMenu0"), "Speed"), ShowOptions())
    },
    ...
    ViewHandBook = function() {
        SetNone($("dOptionsMenuback"), $("dOptionsMenu"));
        oS.Lvl ? (AllAudioPaused(), PlayAudio("gravebutton"), SetNone($("dSurface")), oSym.Stop(), innerText($("dMenu0"), "back to game"), $("dMenu1").onclick = null) : (AllAudioPaused(), PlayAudio("tap"));
...
$SSml = function(d, c, a) {
...
}, Ajax = function() {}, Date.prototype.format = function(b) {
    var c = {
        "M+": this.getMonth() + 1,
        "d+": this.getDate(),
        "h+": this.getHours(),
...
}, oAudio = {}, PausedAudioArr = [], NewAudio = $User.HTML5 ? function(b) {
    var a = b.source;
    if (oAudio[a]) {
        return
    }
    ...
    g && f.addEventListener("ended", function() {
        f.play()
    }, false);
    while (e--) {
    ...
    NewMusic(a)
}, PlayAudio = $User.HTML5 ? function(c, a) {
    var b = oAudio[c];
...
} : function() {}, AllAudioMuted = function() {
    var a;
    for (a in oAudio) {
        oAudio[a].muted = true
    }
