var CPlants = NewO({
    ...
    oGraveBuster = InheritO(CPlants, {
        ...
        Produce: 'Biting the Tombstone is used to eat the tombstone.<p>Instructions:<font color="#FF0000">Single use, only effective on tombstones.</font><br>Features:<font color="#FF0000">Devour tombstones.</font></p>Despite his intimidating appearance, he wants everyone</font><br>Everyone knows that he actually likes kittens, and uses his spare time</font><br>while volunteering at a zombie rehabilitation center. "Im just</font><br>doing the right thing, he said.',
        PrivateBirth: function(a) {
    ...
    oStarfruit = InheritO(CPlants, {
        ...
        Produce: 'Starfruit can fire small starfruits in five directions.<p>Harm:<font color="#FF0000">medium</font><br>Scope:<font color="#FF0000">five directions</font></p>Starfruit: "Hey man, I went to the dentist one day and he said</font><br>I have four cavities. When I count, I only have one tooth! one</font><br>Carambola: "Hey man, theres a tooth with four cavities? Why is that?" I went to the dentist and he said',
    ...
    oPeashooter = InheritO(CPlants, {
        ...
        Produce: 'Pea shooter, your first line of defense. they shoot peas</font><br>beans to attack zombies.<p>Harm:<font color="#FF0000">medium</font></p>How can a plant grow so fast and launch so</font><br>How many peas? Pea Shooter: "Work hard, give yourself</font><br>Self, plus a balance of sunlight, high fiber and carbon oxides</font><br>With, this healthy breakfast makes it all possible. ',
        PrivateBirth: function(a) {
    ...
    oSnowPea = InheritO(oPeashooter, {
        ...
        Produce: 'The Frost Archer fires Frozen Peas to attack enemies and has</font><br>Slow down effect.<p>Harm:<font color="#FF0000">Medium, with a slowing effect</font></p>People often tell the ice shooter how cold he is, or</font><br>Admonish him to be calm. They told him to keep your composure. cold</font><br>The ice shooter just rolled his eyes. In fact, he heard it all.',
        NormalAttack: function() {
            var a = this,
                b = "PB" + Math.random();
            EditEle(a.BulletEle.cloneNode(false), {
    ...
    oSnowRepeater = InheritO(oSnowPea, {
        ...
        Tooltip: "The Dual Ice Archer can fire two bullets with a slowing effect",
        Produce: 'The Twin Ice Archer fires two bullets with a slowing effect.<p>Harm:<font color="#FF0000">medium (each)</font><br>Launch speed:<font color="#FF0000">double</font></p>The dual-shot ice shooter is a shooting enthusiast, he often</font><br>People mention how accurate their shots are. Well, although things</font><br>Not so.',
    ...
    oRepeater = InheritO(oPeashooter, {
        ...
        Produce: 'Dual shooters can shoot two peas at once<p>Harm:<font color="#FF0000">Medium (per piece)</font><br>Launch speed:<font color="#FF0000">double</font></p>The dual shooter is fierce, and he grew up on the street. Hes not in now</font><br>Regardless of anyones opinion, whether its a plant or a zombie, he fights</font><br>Out of peas, is to keep others away from him. Actually, double</font><br>The launcher has been secretly longing for love.',
    ...
    oTwinSunflower = InheritO(oSunFlower, {
        ...
        Tooltip: "Twin sunflowers produce twice as much sunlight as regular sunflowers<br>",
        Produce: 'Twin sunflowers produce twice as much sunlight as regular sunflowers.<p>Sunlight Yield:<font color="#FF0000">double<br>Can be planted on common sunflowers</font></p>Its a crazy night where forbidden science and technology make double</font><br>The cell sunflower came to this world. Lightning, thunder, gust of wind, roar</font><br>, are expressing the worlds rejection of him. but everything</font><br>To no avail, Gemini Sunflower is still alive!',
        CanGrow: function(c, b, f) {
            var a = b + "_" + f,
                d = c[1],
                e = oS.ArP;
    ...
    oPumpkinHead = InheritO(CPlants, {
        ...
        Produce: 'Pumpkin head, can use his shell to protect other plants.<p>Toughness:<font color="#FF0000">high</font><br>Features:<font color="#FF0000">可以种在其他植物上</font></p>Pumpkin head hasnt been received recently, about his cousin Resfield</font><br>information. Clearly, Renfield is a big star, a kind of...</font><br>What is a sports star called...? Pegg jump ball big</font><br>division? Pumpkin Head doesnt understand what exercise is anyway, he just wants to do well</font><br>his own work.',
        CanGrow: function(c, b, d) {
            var a = b + "_" + d;
    ...
    oFlowerPot = InheritO(CPlants, {
        ...
        Produce: 'Pots allow you to grow plants on your roof.<p>Features:<font color="#FF0000">Allows you to plant on the roof</font></p>"I am a pot for plants, but I am also a</font><br>plant. Is it surprising?',
        InitTrigger: function() {}
    }),
    ...
    oLilyPad = InheritO(oFlowerPot, {
        ...
        Produce: '莲叶可以让你种植非水生植物在它上面。<p>Features:<font color="#FF0000">非水生植物可以种植在它上面<br>必须种植在水面</font></p>莲叶从不抱怨，它也从来不想知道发生了什么</font><br>事。在它身上种植物，它也不会说什么。难道</font><br>，它有什么惊奇想法或者可怕的秘密？没人</font><br>知道。莲叶把这些都埋藏在心底。'
    }),
    ...
    oWallNut = InheritO(CPlants, {
        ...
        Tooltip: "Nut Walls have a hard shell that is strong enough to protect other plants.",
        Produce: 'Nut Walls are tough enough for you to use to protect other plants</font><br>shell.<p>Toughness:<font color="FF0000">高</font></p>Wall of Nuts: People want to know what its like to be constantly gnawed by zombies</font><br>how? They dont know that my limited senses can only let me</font><br>Feel a tingling, like, relaxing back massage. "',
        CanGrow: function(c, b, f) {
            var a = b + "_" + f,
                d = c[1],
                e = oS.ArP;
    ...
    oLing = InheritO(oWallNut, {
        ...
        Produce: 'Nanhu Ling is the first obstacle in the water<p>Toughness:<font color="FF0000">high</font></p>Look, how big is a cashew nut?</font><br>He said, but he didnt care. In Nanhulings head, every day only</font><br>think about one thing"If Qianlong didnt open the golden mouth, I wouldnt be able to use it</font><br>Horn to stab zombies? !"',
        CanGrow: function(c, b, d) {
            var a = b + "_" + d;
            return !(d < 1 || d > 9 || oGd.$LF[b] - 2 || c[0] || c[1] || oGd.$Crater[a] || oGd.$Tombstones[a])
        },
    ...
    oTallNut = InheritO(oWallNut, {
        ...
        Tooltip: "不会被跳过的坚实壁垒",
        Produce: '高坚果是重型壁垒植物，而且不会被跳过。<p>Toughness:<font color="#FF0000">非常高</font><br>特殊：<font color="#FF0000">不会被跨过或越过</font></p>人们想知道，坚果墙和高坚果是否在竞争。高</font><br>坚果以男中音的声调大声笑了。“我们之间怎么</font><br>会存在竞争关系？我们是哥们儿。你知道坚果墙</font><br>为我做了什么吗……”高坚果的声音越来越小，</font><br>他狡黠地笑着。”',
        CanGrow: function(c, b, f) {
            var a = b + "_" + f,
                d = c[1],
                e = oS.ArP;
    ...
    oTenManNut = InheritO(CPlants, {
        ...
        ArZ: {},
        Tooltip: "能近距离攻击僵尸",
        Produce: '能近距离攻击僵尸<p>Harm:<font color="#FF0000">普通</font><br>强度：<font color="#FF0000">非常高</font></p>大家一直在质疑高坚果和坚果的特殊关系，直</font><br>到高坚果找到了属于他的藤蔓，这种谣言才不</font><br>攻自散。',
    ...
    oCherryBomb = InheritO(CPlants, {
        ...
        Produce: '樱桃炸弹，能炸掉一定区域内所有僵尸。他们</font><br>一种下就会立刻引爆。所以请把他们种在僵尸</font><br>们的身边。<p>Harm:<font color="#FF0000">巨大</font><br>Scope:<font color="#FF0000">一个中等区域内的所有僵尸</font><br>Instructions:<font color="#FF0000">单独使用，立即爆炸</font></p>“我要‘爆’开了。”樱桃一号说。“不，我们是</font><br>‘炸’开了！”它哥哥樱桃二号说。经过激烈的商</font><br>议之后，他们才统一“爆炸这个说法。”',
        InitTrigger: function() {},
        getHurt: function() {},
        PrivateBirth: function(a) {
    ...
    oSpikeweed = InheritO(CPlants, {
        ...
        Produce: '地刺可以扎破轮胎，并对踩到他的僵尸造成伤</font><br>害<p>Harm:<font color="#FF0000">普通</font><br>Scope:<font color="#FF0000">所有踩到他的僵尸</font><br>Features:<font color="#FF0000">不会被僵尸吃掉</font></p>地刺痴迷冰球，他买了包厢的季票。他一直关</font><br>注着他喜欢的球员，他也始终如一的在赛后清理</font><br>冰球场。但只有一个问题：他害怕冰球。',
        CanGrow: function(c, b, e) {
            var a = b + "_" + e,
                d = oS.ArP;
    ...
    oGarlic = InheritO(CPlants, {
        ...
        Tooltip: "将僵尸赶到其它的横行",
        Produce: '大蒜可以让僵尸改变前进的路线。<p>Scope:<font color="#FF0000">近距离接触</font><br>Features:<font color="#FF0000">改变僵尸的前进路线</font></p>路线转向，这不仅仅是大蒜的专业，更是他</font><br>的热情所在。他在布鲁塞尔大学里，获得了转向</font><br>学的博士学位。他能把路线向量和反击阵列，讲</font><br>上一整天。他甚至会把家里的东西，推到街上去</font><br>。不知道为啥，他老婆还可以忍受这些。',
        CanGrow: function(c, b, f) {
            var a = b + "_" + f,
                d = c[1],
                e = oS.ArP;
    ...
    oSquash = InheritO(CPlants, {
        ...
        Tooltip: "压扁接近的僵尸",
        Produce: '窝瓜会压扁第一个接近它的僵尸。<p>Harm:<font color="#FF0000">极高</font><br>Scope:<font color="#FF0000">短，覆盖所有它压到的僵尸。</font><br>用法：<font color="#FF0000">单独使用</font></p>“我准备好了！”窝瓜大吼道，“干吧！！算我</font><br>一份！没人比我厉害！我就是你要的人！来啊！</font><br>等啥啊？要的就是这个！”',
        GetDY: function(b, c, a) {
            return a[0] ? -21 : -10
        },
        getHurt: function(d, b, a) {
    ...
    oChomper = InheritO(CPlants, {
        ...
        Produce: '大嘴花可以一口吞掉一整只僵尸，但是他们消</font><br>化僵尸的时候很脆弱。<p>Harm:<font color="#FF0000">巨大</font><br>Scope:<font color="#FF0000">非常近</font><br>Features:<font color="#FF0000">消化时间很长</font></p>大嘴花几乎可以去“恐怖小店”，来表演它的绝</font><br>技了，不过他的经纪人压榨了他太多的钱，所</font><br>以他没去成。尽管如此，大嘴花没有怨言，只</font><br>说了句这只是交易的一部分。',
        GetDX: function() {
            return -40
        },
        getShadow: function(a) {
    ...
    oBigChomper = InheritO(oChomper, {
        ...
        Produce: '超级大嘴花能一口气吞下一只僵尸, 并且咀嚼速</font><br>度是普通大嘴花的50%。<p>Harm:<font color="#FF0000">巨大</font><br>Scope:<font color="#FF0000">非常近</font><br>Features:<font color="#FF0000">咀嚼时间短</font></p>超级大嘴花曾经是电视节目“超级大胃王”节</font><br>目的常客，但后来他被踢出了节目组，原因是</font><br>它的存在直接影响到观众的饮食量和节目收视</font><br>率。没办法，为了糊口他只得干起吞食僵尸行</font><br>动。',
        NormalAttack: function(a, b) {
    ...
    oCoffeeBean = InheritO(CPlants, {
        ...
        Produce: '咖啡豆，可以唤醒睡眠中的蘑菇们。<p>Instructions:<font color="#FF0000">单独使用，立即生效</font><br>Features:<font color="#FF0000">可以种在其他植物上，用来唤醒蘑菇们</font></p>咖啡豆：“嘿，伙计们！嘿，怎么回事？是谁？</font><br>嘿！你瞧见那个东西没？什么东西？哇！是狮子</font><br>！”嗯，咖啡豆确定，这样可以让自己很兴奋</font><br>。',
        InitTrigger: function() {},
        GetDBottom: function() {
            return 49
        },
    ...
    oPuffShroom = InheritO(oFumeShroom, {
        ...
        AudioArr: ["puff"],
        Tooltip: "向敌人发射短程孢子",
        Produce: '小喷菇是免费的，不过射程很近。<p>Harm:<font color="#FF0000">中等</font><br>Scope:<font color="#FF0000">近<br>白天要睡觉</font></p>小喷菇：“我也是最近才知道僵尸的存在，和</font><br>很多蘑菇一样，我只是把他们想象成童话和电</font><br>影里的怪物。不过这次的经历已经让我大开眼</font><br>界了。',
    ...
    oScaredyShroom = InheritO(oFumeShroom, {
        ...
        Produce: '胆小菇是一种远程射手，敌人接近后会躲起来。<p>Harm:<font color="#FF0000">普通</font><br>Features:<font color="#FF0000">敌人接近后就停止攻击<br>白天睡觉</font></p>“谁在那？”胆小菇低声说，声音细微难辨。“</font><br>走开！我不想见任何人。除非……除非你是马</font><br>戏团的人。”',
        GetDX: CPlants.prototype.GetDX,
    ...
    oHypnoShroom = InheritO(oFumeShroom, {
        ...
        Tooltip: "让一只僵尸为你作战",
        Produce: '当僵尸吃下魅惑菇后，他将会掉转方向为你作</font><br>战。<p>Instructions:<font color="#FF0000">单独使用，接触生效</font><br>Features:<font color="#FF0000">让一只僵尸为你作战<br>白天睡觉</font></p>魅惑菇声称：“僵尸们是我们的朋友，他们被</font><br>严重误解了，僵尸们在我们的生态环境里扮演着</font><br>重要角色。我们可以也应当更努力地让他们学</font><br>会用我们的方式来思考。”',
        InitTrigger: function() {},
        getHurt: function(d, b, a) {
            var c = this;
            switch (b) {
    ...
    oIceShroom = InheritO(oFumeShroom, {
        ...
        Produce: '寒冰菇，能短暂的冻结屏幕上所有僵尸。<p>Harm:<font color="#FF0000">非常低，冻结僵尸</font><br>Scope:<font color="#FF0000">屏幕上的所有僵尸</font><br>用法：<font color="#FF0000">单独使用，立即生效<br>白天睡觉</font></p>寒冰菇皱着眉头，倒不是因为它不高兴或不满</font><br>意，只是因为，它儿时因受创伤而</font><br>遗留下了面瘫。',
        GetDX: CPlants.prototype.GetDX,
    ...
    oDoomShroom = InheritO(oFumeShroom, {
        ...
        Produce: '毁灭菇可以摧毁大范围的僵尸，并留下一个不</font><br>能种植物的大弹坑。<p>Harm:<font color="#FF0000">极高</font><br>Scope:<font color="#FF0000">大范围内的所有僵尸</font><br>用法：<font color="#FF0000">单独使用，立即生效</font><br>Features:<font color="#FF0000">留下一个弹坑<br>白天睡觉</font></p>“你很幸运，我是和你一伙的，”毁灭菇说，“</font><br>我能摧毁任何你所珍视的东西，小菜一碟。”',
        InitTrigger: function() {},
        BirthStyle: function(c, d, b, a) {
    ...
    oTangleKlep = InheritO(CPlants, {
        ...
        Produce: '缠绕水草是一种可以把接近他的僵尸拉进水中</font><br>的水生植物。<p>Harm:<font color="#FF0000">极高</font><br>用法：<font color="#FF0000">单独使用，接触后生效</font><br>Features:<font color="#FF0000">必须种在水中</font></p>“我是完全隐形的，”缠绕水草自己想，“我就</font><br>藏在水面下，没人会看到我。”他的朋友告诉他</font><br>，他们可以清楚地看到他。不过，缠绕水草似</font><br>乎不想改变自己的看法。',
        CanGrow: function(c, b, d) {
            var a = b + "_" + d;
    ...
    oSeaShroom = InheritO(oPuffShroom, {
        ...
        Produce: '海蘑菇，能够发射短程孢子的水生植物。<p>Harm:<font color="#FF0000">普通</font><br>射程：<font color="#FF0000">短<br>必须种在水上</font></p>海蘑菇从来没看到过大海，大海就在他的名字</font><br>里，他总听到关于大海的事。他只是没找到合适的</font><br>时间，总有一天……是的，他会见到海的。'
    });
oCactus = InheritO(CPlants, {
    ...
    Tooltip: "能发射刺穿气球的子弹",
    Produce: '仙人掌发射的穿刺弹可以用来打击地面和空中</font><br>目标<p>Harm:<font color="#FF0000">中等</font><br>Scope:<font color="#FF0000">地面和空中</font></p>确实，仙人掌非常“刺儿”，但是她的刺下，隐</font><br>藏着颗温柔的心，充满着爱和善良。她只是想拥</font><br>抱别人，和被别人拥抱。大多数人都做不到这点</font><br>，但是仙人掌她并不介意。她盯着一只铠甲鼠好</font><br>一阵子了，这次好像真的可以抱抱了。',
    getShadow: function(a) {
    ...
    Produce: '氧气藻可以提供氧气给地上的植物<p>Toughness:<font color="FF0000">中</font><p><font color="#000000">Scope:<font color="#1F470B">3x3</font></p>噗咕……氧气藻默默地吐着气泡，倒不是他愿</font><br>意一直吐，只怪他昨天喝了太多汽水。不过有传</font><br>言说，他除了吐气泡就不会别的了。',
    CanGrow: function(e, d, f) {
        var c = d + "_" + f,
            b = oGd.$LF[d],
            a = f < 1 || f > 9;
    ...
    Produce: '烈焰菇可以召唤多个毁灭菇，嗨翻全场僵尸<p>Toughness:<font color="FF0000">高</font><p><font color="#000000">技能：<font color="#1F470B">在自身3x3范围内召唤8只毁灭菇</font></p>烈焰菇总是为自己的火焰感到反感，因为它们</font><br>总是伤害到自己的朋友。所以为了朋友，烈焰</font><br>菇到花园里找到了自己的归宿。',
    getHurt: function(e, b, a) {
        var c = this,
            d = $(c.id).childNodes[1];
    ...
    Produce: '路灯花，能照亮一片区域，让你看清战场迷雾<p>Scope:<font color="#FF0000">一片圆形区域</font><br>Features:<font color="#FF0000">使你看清战场迷雾</font></p>灯笼草拒绝科学，他只会埋头苦干。其他植物</font><br>吃的是光，挤出的是氧气。灯笼草吃的是黑暗，</font><br>挤出的却是光。对于他如何能产生光这件事，灯</font><br>笼草持谨慎态度。“我不会说这是‘巫术’，我</font><br>也不会使用‘黑暗力量’，我只是……我想我说</font><br>得够多的了。”',
    PrivateBirth: function(c) {
        var a = c.R,
            b = c.C;
    ...
    Tooltip: "轻型海底作战植物",
    Produce: '水枪草可以直接种在海底，但射程比较短。<p>Harm:<font color="#FF0000">小</font><br>射程：<font color="#FF0000">短</font></p>自从水枪草得到了绝世的吐纳秘籍之后一直在</font><br>不断地练习着，希望自己能够突破三米的射程。',
    PrivateBirth: function(a) {
    ...
    Produce: '荆棘海草会用力抓住靠近他的任何东西并拖入</font><br>地下。<p>Harm:<font color="FF0000">巨大</font><br>Scope:<font color="#FF0000">一格</font><br>Instructions:<font color="#FF0000">一次性使用。</font></p>荆棘海草最近一次的表白又被捷足先登了，这</font><br>使他很伤心。不过很快他就重新振作起来并吸取</font><br>教训。一定要抓住机会！但他似乎对这句话理解</font><br>有误：他无论碰到什么都会死死地抓住。',
    CanGrow: function(e, d, f) {
        var c = d + "_" + f,
            b = oGd.$LF[d],
            a = f < 1 || f > 9;
    ...
    Produce: '磁力菇可以吸走周围僵尸的护具<p>Scope:<font color="#FF0000">约一行</font><br>Instructions:<font color="#FF0000">安放即可使用（一次性）</font></p>磁力是一种强大的力量，非常强大，强大到有</font><br>时都吓到磁力菇自己了。能力越大，责任越大</font><br>，他不知道自己能否肩负得起这责任',
    InitTrigger: function() {},
    getHurt: function() {},
    PrivateBirth: function(a) {
    ...
    Produce: '激光蚕豆向一整排僵尸发射激光<p>Scope:<font color="#FF0000">一整排僵尸<p>本豆由上海宝开绘制<br></font><p><br>这位就是大名鼎鼎的激光豆。但是为什么他是</font><br>蚕豆？恐怕没人搞得清楚。',
    CheckLoop: function(b, c) {
        var a = this.id;
        this.NormalAttack(b);
